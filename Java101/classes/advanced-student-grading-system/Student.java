public class Student {
    ...
    public void addBulkOralNote(int mat, int fizik, int kimya) {
        this.mat.addOralNote(mat);
        this.fizik.addOralNote(fizik);
        this.kimya.addOralNote(kimya);
    }

    public void calcAvarage() {
        double matAvg = mat.calculateCourseAverage();
        double fizikAvg = fizik.calculateCourseAverage();
        double kimyaAvg = kimya.calculateCourseAverage();
